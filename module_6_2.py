...
class Vehicle:
    ...
    def __init__(self, owner: str, model: str, color='yellow', engine_power=50):
        self.owner = owner
        self.__model = model
    ...
    def print_info(self):
        print(f'\033[1m\033[34m{self.get_model()},\033[0m','\n' f'\033[1m\033[34m{self.get_horsepower()},\033[0m','\n' f'\033[1m\033[34m{self.get_color()},\033[0m',
              '\n' f'\033[1m\033[34mВладелец: {self.owner}\033[0m')

    def set_color(self, new_color=str):
        if new_color.lower() in self.__COLOR_VARIANTS:
            self.__color = new_color
        else:
            print(f'\033[1m\033[31mНельзя сменить цвет на {new_color}\033[0m')
class Sedan(Vehicle):
